...
public class UserRegistTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public UserRegistTask(String id, String name, LoginActivity context) {
        this.id = id;
        this.name = name;
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            httppost = new HttpPost(Util.SERVER_ADDRESS + "regist_id.php");
    ...
    protected void onPostExecute(final Boolean success) {
        ...
        if(success){
            Log.e("regist facebook","insert OK");

        }
        else{
            Log.e("regist facebook","already registed");
        }
        context.load_info_me = true;
