...
import com.kchksw.foods6.Activity.LoginActivity;
...
public class GroupsLoadTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public GroupsLoadTask(String facebook_id, LoginActivity context) {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            httppost = new HttpPost(Util.SERVER_ADDRESS + "groups_load.php");
    ...
    protected void onPostExecute(final Boolean success) {
        ...
        if(success){
            Log.e("groups 목록 로딩","성공");
            context.intent.putExtra("jsonGroups",result);
            context.load_info_groups = true;
            context.loadingComplete();

        }
        else{

            Log.e("groups 목록 로딩","실패");
        }
